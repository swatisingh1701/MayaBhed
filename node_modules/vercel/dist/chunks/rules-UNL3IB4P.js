...
async function rules(client, argv) {
  if (argv.length === 0) {
    const lsFn = (await import("./ls-WPNFJAS6.js")).default;
    return lsFn(client, []);
  }
  ...
  switch (subcommand) {
    case "ls":
      return (await import("./ls-WPNFJAS6.js")).default(client, args);
    case "add":
      return (await import("./add-QQY6QOTO.js")).default(client, args);
    case "inspect":
      return (await import("./rule-inspect-HJCERQHK.js")).default(client, args);
    case "rm":
      return (await import("./rm-A45OKS6U.js")).default(client, args);
    case "update":
      return (await import("./update-MOM4T2RN.js")).default(client, args);
    default:
