...
var require_which = __commonJS({
  "../../node_modules/.pnpm/which@1.3.1/node_modules/which/which.js"(exports, module2) {
    ...
    function getNotFoundError(cmd) {
      var er2 = new Error("not found: " + cmd);
      er2.code = "ENOENT";
      return er2;
    }
      ...
      (function F2(i, l) {
        ...
        (function E(ii2, ll) {
          if (ii2 === ll)
            return F2(i + 1, l);
          var ext = pathExt[ii2];
          isexe(p2 + ext, { pathExt: pathExtExe }, function(er2, is2) {
            if (!er2 && is2) {
              if (opt.all)
                found.push(p2 + ext);
              else
                return cb(null, p2 + ext);
            }
            return E(ii2 + 1, ll);
          });
        })(0, pathExt.length);
    ...
    function whichSync(cmd, opt) {
      ...
      for (var i = 0, l = pathEnv.length; i < l; i++) {
        ...
        for (var j2 = 0, ll = pathExt.length; j2 < ll; j2++) {
          var cur = p2 + pathExt[j2];
          var is2;
          try {
...
var require_semver = __commonJS({
  "../../node_modules/.pnpm/semver@5.7.2/node_modules/semver/semver.js"(exports, module2) {
    ...
    function valid(version2, options) {
      var v2 = parse(version2, options);
      return v2 ? v2.version : null;
    }
    exports.clean = clean;
    function clean(version2, options) {
      var s3 = parse(version2.trim().replace(/^[=v]+/, ""), options);
    ...
    SemVer.prototype.comparePre = function(other) {
      ...
      do {
        ...
        debug5("prerelease compare", i2, a, b2);
    ...
    function replaceTilde(comp, options) {
      ...
      return comp.replace(r, function(_2, M2, m2, p2, pr2) {
        debug5("tilde", comp, _2, M2, m2, p2, pr2);
        var ret;
        if (isX(M2)) {
          ret = "";
        } else if (isX(m2)) {
    ...
    function replaceCaret(comp, options) {
      ...
      return comp.replace(r, function(_2, M2, m2, p2, pr2) {
        debug5("caret", comp, _2, M2, m2, p2, pr2);
        var ret;
        if (isX(M2)) {
          ret = "";
        } else if (isX(m2)) {
          ...
          if (M2 === "0") {
            if (m2 === "0") {
              ret = ">=" + M2 + "." + m2 + "." + p2 + "-" + pr2 + " <" + M2 + "." + m2 + "." + (+p2 + 1);
            } else {
              ret = ">=" + M2 + "." + m2 + "." + p2 + "-" + pr2 + " <" + M2 + "." + (+m2 + 1) + ".0";
            }
          } else {
            ret = ">=" + M2 + "." + m2 + "." + p2 + "-" + pr2 + " <" + (+M2 + 1) + ".0.0";
          }
        } else {
          debug5("no pr");
          if (M2 === "0") {
    ...
    function replaceXRange(comp, options) {
      ...
      return comp.replace(r, function(ret, gtlt, M2, m2, p2, pr2) {
        debug5("xRange", comp, ret, gtlt, M2, m2, p2, pr2);
        var xM = isX(M2);
        var xm = xM || isX(m2);
        var xp = xm || isX(p2);
        var anyX = xp;
...
var require_strip_eof = __commonJS({
  "../../node_modules/.pnpm/strip-eof@1.0.0/node_modules/strip-eof/index.js"(exports, module2) {
    ...
    module2.exports = function(x) {
      ...
      var cr2 = typeof x === "string" ? "\r" : "\r".charCodeAt();
      if (x[x.length - 1] === lf) {
...
var require_execa = __commonJS({
  "../../node_modules/.pnpm/execa@1.0.0/node_modules/execa/index.js"(exports, module2) {
    ...
    function handleShell(fn2, cmd, opts) {
      let file = "/bin/sh";
      let args = ["-c", cmd];
...
var require_win32 = __commonJS({
  "../../node_modules/.pnpm/fs-extra@7.0.1/node_modules/fs-extra/lib/mkdirs/win32.js"(exports, module2) {
    ...
    function getRootPath(p2) {
      p2 = path.normalize(path.resolve(p2)).split(path.sep);
      if (p2.length > 0)
        return p2[0];
      return null;
    }
    var INVALID_PATH_CHARS = /[<>:"|?*]/;
    function invalidWin32Path(p2) {
      const rp = getRootPath(p2);
      p2 = p2.replace(rp, "");
      return INVALID_PATH_CHARS.test(p2);
    }
    module2.exports = {
      getRootPath,
      invalidWin32Path
  ...
  "../../node_modules/.pnpm/fs-extra@7.0.1/node_modules/fs-extra/lib/mkdirs/mkdirs.js"(exports, module2) {
    ...
    function mkdirs(p2, opts, callback, made) {
      ...
      xfs.mkdir(p2, mode, (er2) => {
        ...
        switch (er2.code) {
          case "ENOENT":
            if (path.dirname(p2) === p2)
              return callback(er2);
            mkdirs(path.dirname(p2), opts, (er3, made2) => {
              if (er3)
                callback(er3, made2);
              else
                mkdirs(p2, opts, callback, made2);
            });
            break;
          default:
            xfs.stat(p2, (er22, stat) => {
    ...
    function mkdirsSync(p2, opts, made) {
      ...
      try {
        ...
        if (err0.code === "ENOENT") {
          if (path.dirname(p2) === p2)
            throw err0;
          made = mkdirsSync(path.dirname(p2), opts, made);
...
var require_copy = __commonJS({
  "../../node_modules/.pnpm/fs-extra@7.0.1/node_modules/fs-extra/lib/copy/copy.js"(exports, module2) {
    ...
    function checkParentDir(destStat, src, dest, opts, cb) {
      const destParent = path.dirname(dest);
      pathExists5(destParent, (err, dirExists) => {
        if (err)
          return cb(err);
        if (dirExists)
...
var require_rimraf = __commonJS({
  "../../node_modules/.pnpm/fs-extra@7.0.1/node_modules/fs-extra/lib/remove/rimraf.js"(exports, module2) {
    ...
    function rimraf_(p2, options, cb) {
      ...
      options.lstat(p2, (er2, st2) => {
        if (er2 && er2.code === "ENOENT") {
          return cb(null);
        }
        if (er2 && er2.code === "EPERM" && isWindows) {
          return fixWinEPERM(p2, options, er2, cb);
        }
        if (st2 && st2.isDirectory()) {
          return rmdir2(p2, options, er2, cb);
        }
        options.unlink(p2, (er3) => {
          if (er3) {
            if (er3.code === "ENOENT") {
              return cb(null);
            }
            if (er3.code === "EPERM") {
              return isWindows ? fixWinEPERM(p2, options, er3, cb) : rmdir2(p2, options, er3, cb);
            }
            if (er3.code === "EISDIR") {
              return rmdir2(p2, options, er3, cb);
            }
          }
          return cb(er3);
        });
    ...
    function fixWinEPERM(p2, options, er2, cb) {
      assert(p2);
      assert(options);
      assert(typeof cb === "function");
      if (er2) {
        assert(er2 instanceof Error);
      }
      options.chmod(p2, 438, (er22) => {
        if (er22) {
    ...
    function fixWinEPERMSync(p2, options, er2) {
      let stats;
      assert(p2);
      assert(options);
      if (er2) {
      ...
      if (stats.isDirectory()) {
        rmdirSync(p2, options, er2);
      } else {
        options.unlinkSync(p2);
      }
    }
    function rmdir2(p2, options, originalEr, cb) {
      assert(p2);
      assert(options);
      if (originalEr) {
    ...
    function rmkids(p2, options, cb) {
      ...
      options.readdir(p2, (er2, files) => {
        ...
        files.forEach((f2) => {
          rimraf(path.join(p2, f2), options, (er3) => {
            if (errState) {
              return;
            }
            if (er3)
    ...
    function rimrafSync(p2, options) {
      ...
      assert.strictEqual(typeof options, "object", "rimraf: options should be object");
      try {
        st2 = options.lstatSync(p2);
      } catch (er2) {
        if (er2.code === "ENOENT") {
          return;
        }
        if (er2.code === "EPERM" && isWindows) {
          fixWinEPERMSync(p2, options, er2);
        }
      }
      try {
        if (st2 && st2.isDirectory()) {
        ...
        if (er2.code === "ENOENT") {
          return;
        } else if (er2.code === "EPERM") {
          return isWindows ? fixWinEPERMSync(p2, options, er2) : rmdirSync(p2, options, er2);
        } else if (er2.code !== "EISDIR") {
          throw er2;
        }
        rmdirSync(p2, options, er2);
      }
    ...
    function rmdirSync(p2, options, originalEr) {
      ...
      try {
        ...
        if (er2.code === "ENOTDIR") {
          throw originalEr;
        } else if (er2.code === "ENOTEMPTY" || er2.code === "EEXIST" || er2.code === "EPERM") {
          rmkidsSync(p2, options);
        } else if (er2.code !== "ENOENT") {
          throw er2;
        }
      }
    }
    function rmkidsSync(p2, options) {
      assert(p2);
      assert(options);
      options.readdirSync(p2).forEach((f2) => rimrafSync(path.join(p2, f2), options));
      if (isWindows) {
  ...
  "../../node_modules/.pnpm/fs-extra@7.0.1/node_modules/fs-extra/lib/ensure/file.js"(exports, module2) {
    ...
    function createFile(file, callback) {
      ...
      fs3.stat(file, (err, stats) => {
        ...
        pathExists5(dir, (err2, dirExists) => {
          if (err2)
            return callback(err2);
          if (dirExists)
            return makeFile();
...
var require_link = __commonJS({
  "../../node_modules/.pnpm/fs-extra@7.0.1/node_modules/fs-extra/lib/ensure/link.js"(exports, module2) {
    ...
    function createLink(srcpath, dstpath, callback) {
      ...
      pathExists5(dstpath, (err, destinationExists) => {
        if (err)
          return callback(err);
        ...
        fs3.lstat(srcpath, (err2) => {
          ...
          pathExists5(dir, (err3, dirExists) => {
            if (err3)
              return callback(err3);
            if (dirExists)
  ...
  "../../node_modules/.pnpm/fs-extra@7.0.1/node_modules/fs-extra/lib/ensure/symlink-paths.js"(exports, module2) {
    ...
    function symlinkPaths(srcpath, dstpath, callback) {
      if (path.isAbsolute(srcpath)) {
        ...
        return pathExists5(relativeToDst, (err, exists) => {
          if (err)
            return callback(err);
          if (exists) {
            return callback(null, {
        ...
        symlinkPaths(srcpath, dstpath, (err2, relative2) => {
          ...
          symlinkType(relative2.toCwd, type, (err3, type2) => {
            if (err3)
              return callback(err3);
            const dir = path.dirname(dstpath);
            pathExists5(dir, (err4, dirExists) => {
              if (err4)
                return callback(err4);
              if (dirExists)
...
var require_string_argv = __commonJS({
  "../../node_modules/.pnpm/string-argv@0.3.1/node_modules/string-argv/index.js"(exports) {
    ...
    function firstString() {
      var args = [];
      for (var _i9 = 0; _i9 < arguments.length; _i9++) {
        args[_i9] = arguments[_i9];
      }
      for (var i = 0; i < args.length; i++) {
        var arg = args[i];
      ...
      function intercept(type, interceptor) {
        ...
        if (!this._interceptors[type].warned) {
          if (typeof this._maxInterceptors !== "undefined") {
            m2 = this._maxInterceptors;
          } else {
            m2 = EventEmitter.defaultMaxInterceptors;
          }
          if (m2 && m2 > 0 && this._interceptors[type].length > m2) {
...
var require_lib5 = __commonJS({
  "../../node_modules/.pnpm/yauzl-clone@1.0.4/node_modules/yauzl-clone/lib/index.js"(exports, module2) {
    ...
    function patchAll(yauzl2, fn2) {
      patch(yauzl2, "open", fn2);
      patch(yauzl2, "fromFd", fn2);
      patch(yauzl2, "fromBuffer", fn2);
      patch(yauzl2, "fromRandomAccessReader", fn2);
    }
    function patch(yauzl2, methodName, fn2) {
      const original = yauzl2[methodName];
      if (methodName == "fromRandomAccessReader") {
        const shimmed = fn2(original);
        ...
        const shimmed = fn2(function(path, unused, options, callback) {
...
var require_promisify = __commonJS({
  "../../node_modules/.pnpm/yauzl-promise@2.1.3/node_modules/yauzl-promise/lib/promisify.js"(exports, module2) {
    ...
    function walkNextEntry(zipFile, fn2, numEntries, count, cb) {
      if (numEntries && count == numEntries)
        return cb();
      zipFile.readEntry().then((entry) => {
        if (!entry)
          return cb();
        return fn2(entry).then(() => {
          walkNextEntry(zipFile, fn2, numEntries, count + 1, cb);
        });
      }).catch((err) => {
        cb(err);
      });
    ...
    function wrapFunctionToReturnPromise(fn2, Promise2) {
      return function() {
        try {
...
var require_lib7 = __commonJS({
  "../../node_modules/.pnpm/os-paths@4.4.0/node_modules/os-paths/src/lib/index.js"(exports, module2) {
    ...
    var base = () => {
      const { env } = process;
      const object = {};
      object.home = () => normalize_path(os2.homedir ? os2.homedir() : env.HOME);
      object.temp = () => normalize_path(os2.tmpdir ? os2.tmpdir() : env.TMPDIR || env.TEMP || env.TMP);
      return object;
    };
    var windows = () => {
      const { env } = process;
      ...
      object.home = () => normalize_path(
        os2.homedir ? os2.homedir() : env.USERPROFILE || paths.join(env.HOMEDRIVE, env.HOMEPATH) || env.HOME
      );
      object.temp = () => normalize_path(
        os2.tmpdir ? os2.tmpdir() : env.TEMP || env.TMP || paths.join(env.LOCALAPPDATA || env.SystemRoot || env.windir, "Temp")
      );
      return object;
    };
  ...
  "../../node_modules/.pnpm/xdg-app-paths@5.1.0/node_modules/xdg-app-paths/index.js"(exports, module2) {
    ...
    var base = (name, isolated) => {
      ...
      object.configDirs = (options = { isolated: null }) => {
        options = _normalizeOptions(options, isolated);
        return xdg.configDirs().map((s3) => path.join(s3, options.isolated ? name : ""));
      };
      object.dataDirs = (options = { isolated: null }) => {
        options = _normalizeOptions(options, isolated);
        return xdg.dataDirs().map((s3) => path.join(s3, options.isolated ? name : ""));
      };
      return object;
    };
    var windows = (name, isolated) => {
      ...
      object.configDirs = (options = { isolated: null }) => {
        ...
        if (env.XDG_CONFIG_DIRS) {
          dirs.push(...env.XDG_CONFIG_DIRS.split(path.delimiter).map((s3) => path.join(s3, options.isolated ? name : "")));
        }
        return dirs;
      };
      object.dataDirs = (options = { isolated: null }) => {
        ...
        if (env.XDG_DATA_DIRS) {
          dirs.push(...env.XDG_DATA_DIRS.split(path.delimiter).map((s3) => path.join(s3, options.isolated ? name : "")));
        }
        return dirs;
      };
      return object;
...
var Ar = (s3, t) => {
  for (var e in t)
    Dr(s3, e, { get: t[e], enumerable: true });
};
...
var _a, _b, _c, _d, _e, _f, _g, _h, _i2, _j, _k, _l, _m, _n, _o, _p, _q, _r, _s;
var A = class extends import_node_events.EventEmitter {
  ...
  [(_a = b, _b = Qt, _c = D, _d = g, _e = L, _f = z, _g = Z, _h = Mt, _i2 = q, _j = rt, _k = xe, _l = Le, _m = jt, _n = _, _o = w, _p = Jt, _q = Ae, _r = yt, _s = C, gi)]() {
  ...
  on(t, e) {
    let i = super.on(t, e);
    if (t === "data")
      this[C] = false, this[yt]++, !this[D].length && !this[b] && this[Bt]();
    else if (t === "readable" && this[_] !== 0)
      super.emit("readable");
    else if (Mr(t) && this[rt])
  ...
  emit(t, ...e) {
    ...
    if (t !== "error" && t !== "close" && t !== w && this[w])
      return false;
    if (t === "data")
      return !this[L] && !i ? false : this[Z] ? (te(() => this[Ri](i)), true) : this[Ri](i);
    if (t === "end")
      return this[Ns]();
    if (t === "close") {
      if (this[Le] = true, !this[rt] && !this[w])
        return false;
...
var gt = class extends A {
  constructor(t, e) {
    ...
    __publicField(this, _e2, false);
    __publicField(this, _f2);
    __publicField(this, _g2);
    __publicField(this, _h2);
    if (this.readable = true, this.writable = false, typeof t != "string")
  ...
  [(_a2 = bt, _b2 = m, _c2 = U, _d2 = Ni, _e2 = Q, _f2 = Di, _g2 = ie, _h2 = ot, ht)]() {
  ...
  [zt]() {
    if (!this[Q]) {
      ...
      let t = this[Ii]();
      if (t.length === 0)
        return process.nextTick(() => this[Li](null, 0, t));
...
var _a3, _b3, _c3, _d3, _e3, _f3, _g3, _h3, _i3, _j2, _k2, _l2, _m2;
var tt = class extends import_events.default {
  constructor(t, e) {
    ...
    __publicField(this, _b3, false);
    __publicField(this, _c3, false);
    __publicField(this, _d3, []);
    __publicField(this, _e3, false);
    __publicField(this, _f3);
    __publicField(this, _g3);
    __publicField(this, _h3);
    __publicField(this, _i3);
    __publicField(this, _j2);
    __publicField(this, _k2);
    __publicField(this, _l2, false);
    __publicField(this, _m2);
    this[U] = t, this[m] = typeof e.fd == "number" ? e.fd : void 0, this[se] = e.mode === void 0 ? 438 : e.mode, this[nt] = typeof e.start == "number" ? e.start : void 0, this[ot] = typeof e.autoClose == "boolean" ? e.autoClose : true;
  ...
  [(_a3 = bt, _b3 = Rt, _c3 = ee, _d3 = Y, _e3 = Ce, _f3 = U, _g3 = se, _h3 = ot, _i3 = m, _j2 = ke, _k2 = J, _l2 = Ti, _m2 = nt, Ut)](t) {
...
var Gt = class extends Error {
  constructor(t, e) {
    super("zlib: " + t.message, { cause: t });
    __publicField(this, "code");
    __publicField(this, "errno");
    this.code = t.code, this.errno = t.errno, this.code || (this.code = "ZLIB_ERROR"), this.message = "zlib: " + t.message, Error.captureStackTrace(this, e ?? this.constructor);
  }
  get name() {
    return "ZlibError";
  }
...
var _t2, _i4, _s2, _n2, _r2, _e4, _o2, _a4;
var ne = (_a4 = class extends A {
  constructor(t, e) {
    if (!t || typeof t != "object")
      throw new TypeError("invalid options for ZlibBase constructor");
    super(t);
    __privateAdd(this, _t2, false);
    __privateAdd(this, _i4, false);
    ...
    if (__privateSet(this, _s2, t.flush ?? 0), __privateSet(this, _n2, t.finishFlush ?? 0), __privateSet(this, _r2, t.fullFlushFlag ?? 0), typeof vs[e] != "function")
      throw new TypeError("Compression method not supported: " + e);
    try {
      __privateSet(this, _e4, new vs[e](t));
    } catch (i) {
      throw new Gt(i, this.constructor);
    }
    __privateSet(this, _o2, (i) => {
      __privateGet(this, _t2) || (__privateSet(this, _t2, true), this.close(), this.emit("error", i));
    }), __privateGet(this, _e4)?.on("error", (i) => __privateGet(this, _o2).call(this, new Gt(i))), this.once("end", () => this.close);
  }
  get sawError() {
  ...
  close() {
    __privateGet(this, _e4) && (__privateGet(this, _e4).close(), __privateSet(this, _e4, void 0), this.emit("close"));
  }
  reset() {
    if (!__privateGet(this, _t2))
      return (0, import_assert.default)(__privateGet(this, _e4), "zlib binding closed"), __privateGet(this, _e4).reset?.();
  }
  flush(t) {
    this.ended || (typeof t != "number" && (t = __privateGet(this, _r2)), this.write(Object.assign(import_buffer.Buffer.alloc(0), { [ki]: t })));
  }
  end(t, e, i) {
    return typeof t == "function" && (i = t, e = void 0, t = void 0), typeof e == "function" && (i = e, e = void 0), t && (e ? this.write(t, e) : this.write(t)), this.flush(__privateGet(this, _n2)), __privateSet(this, _i4, true), super.end(i);
  }
  get ended() {
  ...
  write(t, e, i) {
    if (typeof e == "function" && (i = e, e = "utf8"), typeof t == "string" && (t = import_buffer.Buffer.from(t, e)), __privateGet(this, _t2))
      return;
    (0, import_assert.default)(__privateGet(this, _e4), "zlib binding closed");
    let r = __privateGet(this, _e4)._handle, n = r.close;
    r.close = () => {
    };
    let o = __privateGet(this, _e4).close;
    __privateGet(this, _e4).close = () => {
    }, Fi(true);
    let h;
    try {
      let l = typeof t[ki] == "number" ? t[ki] : __privateGet(this, _s2);
      h = __privateGet(this, _e4)._processChunk(t, l), Fi(false);
    } catch (l) {
      Fi(false), __privateGet(this, _o2).call(this, new Gt(l, this.write));
    } finally {
      __privateGet(this, _e4) && (__privateGet(this, _e4)._handle = r, r.close = n, __privateGet(this, _e4).close = o, __privateGet(this, _e4).removeAllListeners("error"));
    }
    __privateGet(this, _e4) && __privateGet(this, _e4).on("error", (l) => __privateGet(this, _o2).call(this, new Gt(l, this.write)));
    let a;
    if (h)
      if (Array.isArray(h) && h.length > 0) {
        ...
        a = this[Ot](import_buffer.Buffer.from(h));
    return i && i(), a;
  }
}, _t2 = new WeakMap(), _i4 = new WeakMap(), _s2 = new WeakMap(), _n2 = new WeakMap(), _r2 = new WeakMap(), _e4 = new WeakMap(), _o2 = new WeakMap(), _a4);
var _t3, _i5, _a5;
var Me = (_a5 = class extends ne {
  constructor(t, e) {
    t = t || {}, t.flush = t.flush || M.Z_NO_FLUSH, t.finishFlush = t.finishFlush || M.Z_FINISH, t.fullFlushFlag = M.Z_FULL_FLUSH;
    super(t, e);
    __privateAdd(this, _t3, void 0);
    __privateAdd(this, _i5, void 0);
    __privateSet(this, _t3, t.level), __privateSet(this, _i5, t.strategy);
  }
  params(t, e) {
    if (!this.sawError) {
      if (!this.handle)
      ...
      if (__privateGet(this, _t3) !== t || __privateGet(this, _i5) !== e) {
        ...
        this.handle && (__privateSet(this, _t3, t), __privateSet(this, _i5, e));
      }
    }
  }
}, _t3 = new WeakMap(), _i5 = new WeakMap(), _a5);
var _t4, _a6;
var Be = (_a6 = class extends Me {
  constructor(t) {
    super(t, "Gzip");
    __privateAdd(this, _t4, void 0);
    __privateSet(this, _t4, t && !!t.portable);
  }
  [Ot](t) {
    return __privateGet(this, _t4) ? (__privateSet(this, _t4, false), t[9] = 255, super[Ot](t)) : super[Ot](t);
  }
}, _t4 = new WeakMap(), _a6);
...
var Bs = (s3, t) => {
  if (Number.isSafeInteger(s3))
    s3 < 0 ? jr(s3, t) : qr(s3, t);
  else
...
var qr = (s3, t) => {
  ...
  for (var e = t.length; e > 1; e--)
    t[e - 1] = s3 & 255, s3 = Math.floor(s3 / 256);
};
var jr = (s3, t) => {
  t[0] = 255;
  var e = false;
...
var F = (_a7 = class {
  constructor(t, e = 0, i, r) {
    ...
    __privateAdd(this, _t5, "Unsupported");
    ...
    Buffer.isBuffer(t) ? this.decode(t, e || 0, i, r) : t && __privateMethod(this, _i6, i_fn).call(this, t);
  }
  decode(t, e, i, r) {
    if (e || (e = 0), !t || !(t.length >= e + 512))
      throw new Error("need 512 bytes for header");
    this.path = i?.path ?? Tt(t, e, 100), this.mode = i?.mode ?? r?.mode ?? at(t, e + 100, 8), this.uid = i?.uid ?? r?.uid ?? at(t, e + 108, 8), this.gid = i?.gid ?? r?.gid ?? at(t, e + 116, 8), this.size = i?.size ?? r?.size ?? at(t, e + 124, 12), this.mtime = i?.mtime ?? r?.mtime ?? Bi(t, e + 136, 12), this.cksum = at(t, e + 148, 12), r && __privateMethod(this, _i6, i_fn).call(this, r, true), i && __privateMethod(this, _i6, i_fn).call(this, i);
    let n = Tt(t, e + 156, 1);
    if (oe(n) && __privateSet(this, _t5, n || "0"), __privateGet(this, _t5) === "0" && this.path.slice(-1) === "/" && __privateSet(this, _t5, "5"), __privateGet(this, _t5) === "5" && (this.size = 0), this.linkpath = Tt(t, e + 157, 100), t.subarray(e + 257, e + 265).toString() === "ustar\x0000")
  ...
  encode(t, e = 0) {
    if (t || (t = this.block = Buffer.alloc(512)), __privateGet(this, _t5) === "Unsupported" && __privateSet(this, _t5, "0"), !(t.length >= e + 512))
      throw new Error("need 512 bytes for header");
    let i = this.ctime || this.atime ? 130 : 155, r = sn(this.path || "", i), n = r[0], o = r[1];
    this.needPax = !!r[2], this.needPax = xt(t, e, 100, n) || this.needPax, this.needPax = lt(t, e + 100, 8, this.mode) || this.needPax, this.needPax = lt(t, e + 108, 8, this.uid) || this.needPax, this.needPax = lt(t, e + 116, 8, this.gid) || this.needPax, this.needPax = lt(t, e + 124, 12, this.size) || this.needPax, this.needPax = Pi(t, e + 136, 12, this.mtime) || this.needPax, t[e + 156] = __privateGet(this, _t5).charCodeAt(0), this.needPax = xt(t, e + 157, 100, this.linkpath) || this.needPax, t.write("ustar\x0000", e + 257, 8), this.needPax = xt(t, e + 265, 32, this.uname) || this.needPax, this.needPax = xt(t, e + 297, 32, this.gname) || this.needPax, this.needPax = lt(t, e + 329, 8, this.devmaj) || this.needPax, this.needPax = lt(t, e + 337, 8, this.devmin) || this.needPax, this.needPax = xt(t, e + 345, i, o) || this.needPax, t[e + 475] !== 0 ? this.needPax = xt(t, e + 345, 155, o) || this.needPax : (this.needPax = xt(t, e + 345, 130, o) || this.needPax, this.needPax = Pi(t, e + 476, 12, this.atime) || this.needPax, this.needPax = Pi(t, e + 488, 12, this.ctime) || this.needPax);
    let h = 256;
  ...
  get type() {
    return __privateGet(this, _t5) === "Unsupported" ? __privateGet(this, _t5) : he.get(__privateGet(this, _t5));
  }
  get typeKey() {
...
}, _t5 = new WeakMap(), _i6 = new WeakSet(), i_fn = function(t, e = false) {
...
var Yt = (_a8 = class extends A {
  constructor(t, e, i) {
    ...
    switch (this.pause(), this.extended = e, this.globalExtended = i, this.header = t, this.remain = t.size ?? 0, this.startBlockSize = 512 * Math.ceil(this.remain / 512), this.blockRemain = this.startBlockSize, this.type = t.type, this.type) {
      case "File":
      case "OldFile":
      case "Link":
      case "SymbolicLink":
    ...
    this.path = f(t.path), this.mode = t.mode, this.mode && (this.mode = this.mode & 4095), this.uid = t.uid, this.gid = t.gid, this.uname = t.uname, this.gname = t.gname, this.size = this.remain, this.mtime = t.mtime, this.atime = t.atime, this.ctime = t.ctime, this.linkpath = t.linkpath ? f(t.linkpath) : void 0, this.uname = t.uname, this.gname = t.gname, e && __privateMethod(this, _t6, t_fn).call(this, e), i && __privateMethod(this, _t6, t_fn).call(this, i, true);
  }
  write(t) {
    let e = t.length;
...
}, _t6 = new WeakSet(), t_fn = function(t, e = false) {
...
var Rn = () => true;
var _a9, _b4, _c4, _d4, _e5, _f4, _g4, _h4, _i7, _j3, _k3, _l3, _m3, _n3, _o3, _p2, _q2;
var st = class extends import_events2.EventEmitter {
  constructor(t = {}) {
    ...
    __publicField(this, _e5, "begin");
    __publicField(this, _f4, "");
    __publicField(this, _g4);
    __publicField(this, _h4);
    __publicField(this, _i7, false);
    __publicField(this, _j3);
    __publicField(this, _k3, false);
    __publicField(this, _l3);
    __publicField(this, _m3, false);
    __publicField(this, _n3, false);
    __publicField(this, _o3, false);
    __publicField(this, _p2, false);
    __publicField(this, _q2, false);
    this.file = t.file || "", this.on(Xe, () => {
  ...
  [(_a9 = it, _b4 = p, _c4 = et, _d4 = Nt, _e5 = B, _f4 = ft, _g4 = V, _h4 = ae, _i7 = dt, _j3 = y, _k3 = ut, _l3 = At, _m3 = qe, _n3 = je, _o3 = Kt, _p2 = le, _q2 = Ui, Zs)](t, e) {
    ...
    if (i.nullBlock)
      this[qe] ? (this[je] = true, this[B] === "begin" && (this[B] = "header"), this[Dt]("eof")) : (this[qe] = true, this[Dt]("nullBlock"));
    else if (this[qe] = false, !i.cksumValid)
  ...
  [Hs](t) {
    let e = true;
    if (!t)
      this[et] = void 0, e = false;
    else if (Array.isArray(t)) {
      let [i, ...r] = t;
      this.emit(i, ...r);
    } else
      this[et] = t, this.emit("entry", t), t.emittedEnd || (t.on("end", () => this[zi]()), e = false);
    return e;
  }
  [zi]() {
    do
  ...
  write(t, e, i) {
    if (typeof e == "function" && (i = e, e = void 0), typeof t == "string" && (t = Buffer.from(t, typeof e == "string" ? e : "utf8")), this[ut])
      return i?.(), false;
    if ((this[y] === void 0 || this.brotli === void 0 && this[y] === false) && t) {
      if (this[p] && (t = Buffer.concat([this[p], t]), this[p] = void 0), t.length < yn)
        return this[p] = t, i?.(), true;
      for (let a = 0; this[y] === void 0 && a < Gi.length; a++)
        t[a] !== Gi[a] && (this[y] = false);
      let o = false;
...
var It = K(On, Tn, (s3) => new st(s3), (s3) => new st(s3), (s3, t) => {
  t?.length && Yi(s3, t), s3.noResume || _n4(s3);
});
...
var de = (_a10 = class extends A {
  ...
  emit(t, ...e) {
    return t === "error" && __privateSet(this, _t7, true), super.emit(t, ...e);
  }
  [ji]() {
  ...
  [es](t) {
    if (this.fd = t, __privateGet(this, _t7))
      return this[pt]();
    if (!this.stat)
...
var si = class extends A {
  constructor(t, e = {}) {
    ...
    __publicField(this, "size");
    __publicField(this, "onWriteEntry");
    this.preservePaths = !!i.preservePaths, this.portable = !!i.portable, this.strict = !!i.strict, this.noPax = !!i.noPax, this.noMtime = !!i.noMtime, this.onWriteEntry = i.onWriteEntry, this.readEntry = t;
    let { type: r } = t;
    if (r === "Unsupported")
...
var Et = class extends A {
  ...
  [(_a11 = li, _b5 = W, _c5 = G, _d5 = pe, _e6 = me, nr)](t) {
    return super.write(t);
  }
  add(t) {
  ...
  [Ft]() {
    if (!this[pe]) {
      ...
      for (let t = this[W].head; t && this[G] < this.jobs; t = t.next)
        if (this[ss](t.value), t.value.ignore) {
          let e = t.next;
    ...
    if (!t.pending) {
      ...
      if (t.stat && !t.ignore) {
        if (!this.noDirRecurse && t.stat.isDirectory() && !t.readdir) {
          ...
          if (e ? this[hi](t, e) : this[as](t), !t.readdir)
            return;
        }
...
var $n = (s3, t, e, i, r) => {
  if (t.isDirectory())
    fs(import_node_path6.default.resolve(s3, t.name), e, i, (n) => {
      if (n)
        return r(n);
...
var fr = (s3, t, e) => {
  ...
  let i = t.umask ?? 18, r = t.mode | 448, n = (r & i) !== 0, o = t.uid, h = t.gid, a = typeof o == "number" && typeof h == "number" && (o !== t.processUid || h !== t.processGid), l = t.preserve, c = t.unlink, d = f(t.cwd), S = (E, x) => {
    E ? e(E) : x && a ? fs(x, o, h, (_s4) => S(_s4)) : n ? import_node_fs5.default.chmod(s3, r, e) : e();
  };
  if (s3 === d)
    return jn(s3, S);
  if (l)
    return import_promises.default.mkdir(s3, { mode: r, recursive: true }).then((E) => S(null, E ?? void 0), S);
...
var dr = (s3, t, e, i, r, n, o) => (h) => {
  h ? import_node_fs5.default.lstat(s3, (a, l) => {
    if (a)
      ...
      import_node_fs5.default.unlink(s3, (c) => {
        if (c)
          return o(c);
...
var ur = (s3, t) => {
  ...
  if (s3 === c)
    return Qn(c), d();
  if (a)
    return d(import_node_fs5.default.mkdirSync(s3, { mode: i, recursive: true }) ?? void 0);
...
var _t8, _i8, _s3, _n5, n_fn, _r3, r_fn, _e7, e_fn, _a12;
var pi = (_a12 = class {
  constructor() {
    __privateAdd(this, _n5);
    __privateAdd(this, _r3);
    __privateAdd(this, _e7);
    __privateAdd(this, _t8, /* @__PURE__ */ new Map());
    __privateAdd(this, _i8, /* @__PURE__ */ new Map());
    __privateAdd(this, _s3, /* @__PURE__ */ new Set());
  }
  reserve(t, e) {
    ...
    __privateGet(this, _i8).set(e, { dirs: i, paths: t });
    for (let r of t) {
      let n = __privateGet(this, _t8).get(r);
      n ? n.push(e) : __privateGet(this, _t8).set(r, [e]);
    }
    for (let r of i) {
      let n = __privateGet(this, _t8).get(r);
      if (!n)
        __privateGet(this, _t8).set(r, [/* @__PURE__ */ new Set([e])]);
      else {
        let o = n[n.length - 1];
        o instanceof Set ? o.add(e) : n.push(/* @__PURE__ */ new Set([e]));
      }
    }
    return __privateMethod(this, _r3, r_fn).call(this, e);
  }
  check(t) {
    let { paths: e, dirs: i } = __privateMethod(this, _n5, n_fn).call(this, t);
    return e.every((r) => r && r[0] === t) && i.every((r) => r && r[0] instanceof Set && r[0].has(t));
  }
}, _t8 = new WeakMap(), _i8 = new WeakMap(), _s3 = new WeakMap(), _n5 = new WeakSet(), n_fn = function(t) {
  let e = __privateGet(this, _i8).get(t);
  if (!e)
    throw new Error("function does not have any path reservations");
  return { paths: e.paths.map((i) => __privateGet(this, _t8).get(i)), dirs: [...e.dirs].map((i) => __privateGet(this, _t8).get(i)) };
}, _r3 = new WeakSet(), r_fn = function(t) {
  return __privateGet(this, _s3).has(t) || !this.check(t) ? false : (__privateGet(this, _s3).add(t), t(() => __privateMethod(this, _e7, e_fn).call(this, t)), true);
}, _e7 = new WeakSet(), e_fn = function(t) {
  if (!__privateGet(this, _s3).has(t))
    return false;
  let e = __privateGet(this, _i8).get(t);
  if (!e)
  ...
  for (let o of i) {
    let h = __privateGet(this, _t8).get(o);
    if (!h || h?.[0] !== t)
      continue;
    let a = h[1];
    if (!a) {
      __privateGet(this, _t8).delete(o);
      continue;
    }
  ...
  for (let o of r) {
    let h = __privateGet(this, _t8).get(o), a = h?.[0];
  ...
  return __privateGet(this, _s3).delete(t), n.forEach((o) => __privateMethod(this, _r3, r_fn).call(this, o)), true;
}, _a12);
...
var be = Symbol("uid");
var ge = Symbol("gid");
var _e8 = Symbol("checkedCwd");
var so = process.env.TESTING_TAR_FAKE_PLATFORM || process.platform;
var Oe = so === "win32";
var ro = 1024;
var no = (s3, t) => {
  if (!Oe)
    return import_node_fs3.default.unlink(s3, t);
...
var oo = (s3) => {
  if (!Oe)
    return import_node_fs3.default.unlinkSync(s3);
...
var qt = class extends st {
  constructor(t = {}) {
    ...
    super(t);
    __publicField(this, _a13, false);
    __publicField(this, _b6, false);
    __publicField(this, _c6, 0);
    __publicField(this, "reservations", new pi());
    ...
    if (this.transform = t.transform, this.chmod = !!t.chmod, typeof t.uid == "number" || typeof t.gid == "number") {
      ...
      this.uid = void 0, this.gid = void 0, this.setOwner = false;
  ...
  [_r4](t) {
    ...
    if (!this[ps](t, "path") || !this[ps](t, "linkpath"))
      return false;
    if (import_node_path5.default.isAbsolute(t.path) ? t.absolute = f(import_node_path5.default.resolve(t.path)) : t.absolute = f(import_node_path5.default.resolve(this.cwd, t.path)), !this.preservePaths && typeof t.absolute == "string" && t.absolute.indexOf(this.cwd + "/") !== 0 && t.absolute !== this.cwd)
  ...
  [ye](t, e, i, r, n) {
    let o = i.shift();
    if (this.preservePaths || o === void 0)
      return r();
    ...
    import_node_fs3.default.lstat(h, (a, l) => {
      if (a)
        return r();
      if (l?.isSymbolicLink())
        return n(new wt(h, import_node_path5.default.resolve(h, i.join("/"))));
      this[ye](t, h, i, r, n);
    });
  }
  [Or]() {
    ...
    let i = (h) => {
      ...
      import_node_fs3.default.lstat(String(t.absolute), (h, a) => {
        ...
        if (a.isDirectory()) {
          ...
          if (t.absolute !== this.cwd)
            return import_node_fs3.default.rmdir(String(t.absolute), (l) => this[P](l ?? null, t, i));
        }
        if (t.absolute === this.cwd)
          return this[P](null, t, i);
...
var Te = class extends qt {
  ...
  [ye](t, e, i, r, n) {
    if (this.preservePaths || !i.length)
      return r();
    let o = e;
    for (let h of i) {
      ...
      if (a)
        return r();
      if (l.isSymbolicLink())
        return n(new wt(o, import_node_path5.default.resolve(e, i.join("/"))));
    }
    r();
  }
  [wi](t, e, i, r) {
...
var co = (s3, t) => {
  ...
  try {
    try {
      ...
      if (a?.code === "ENOENT")
        r = import_node_fs6.default.openSync(s3.file, "w+");
      else
        throw a;
    }
    ...
    t:
      for (n = 0; n < o.size; n += 512) {
        for (let c = 0, d = 0; c < 512; c += d) {
          if (d = import_node_fs6.default.readSync(r, h, c, h.length - c, n + c), n === 0 && h[0] === 31 && h[1] === 139)
  ...
  let e = new Et(s3), i = (n, o, h) => {
    ...
    let c = 0, d = Buffer.alloc(512), S = (T, N) => {
      if (T || typeof N > "u")
        return a(T);
      if (c += N, c < 512 && N)
        return import_node_fs6.default.read(n, d, c, d.length - c, l + c, S);
  ...
  return new Promise((n, o) => {
    ...
    let h = "r+", a = (l, c) => {
      if (l && l.code === "ENOENT" && h === "r+")
        return h = "w+", import_node_fs6.default.open(s3.file, h, a);
      if (l || !c)
        return o(l);
      import_node_fs6.default.fstat(c, (d, S) => {
        if (d)
          return import_node_fs6.default.close(c, () => o(d));
        i(c, S.size, (T, N) => {
          if (T)
            return o(T);
...
var localCacheDir = (0, import_path4.join)(".vercel", "cache", "golang");
...
function getGoUrl(version2) {
  ...
  if (platform === "darwin" && goArch === "arm64" && parseInt(/^\d+.(\d+)/.exec(version2)[1], 10) < 16) {
    goArch = "amd64";
  }
...
function enrichGoCommandError(error) {
  if (!(error instanceof Error)) {
    return error;
  }
  const output = getGoCommandOutput(error);
...
async function getAnalyzedEntrypoint({
  ...
  const bin = (0, import_path4.join)(__dirname, `analyze${OUT_EXTENSION}`);
  let analyzed;
  try {
    const isAnalyzeExist = await (0, import_fs_extra.pathExists)(bin);
    if (!isAnalyzeExist) {
      (0, import_build_utils.debug)(`Building analyze bin: ${bin}`);
      const src = (0, import_path4.join)(__dirname, "../analyze.go");
      let go;
      const createOpts = {
        modulePath,
        opts: { cwd: __dirname },
  ...
  try {
    ...
    const args = [`-modpath=${modulePath}`, (0, import_path4.join)(workPath, entrypoint)];
...
var GoWrapper = class {
  ...
  async execute(...args) {
    ...
    const captureAndForwardOutput = opts.stdio === void 0 || opts.stdio === "inherit";
...
async function createGo({
  ...
  if (goPreferredVersion) {
    (0, import_build_utils.debug)(`Preferred go version ${goSelectedVersion} (from go.mod)`);
    env.GO111MODULE = "on";
  } else {
    (0, import_build_utils.debug)(
  ...
  const setGoEnv = async (goDir) => {
    ...
    const setEnvPaths = (modCache, buildCache) => {
      env.GOMODCACHE = modCache;
      env.GOCACHE = buildCache;
      (0, import_build_utils.debug)(`Set GOMODCACHE to ${env.GOMODCACHE}`);
      (0, import_build_utils.debug)(`Set GOCACHE to ${env.GOCACHE}`);
    };
    if (isUnix && goDir === goGlobalCacheDir) {
      ...
      await (0, import_fs_extra.mkdirp)((0, import_path4.dirname)(goCacheDir));
      await (0, import_fs_extra.symlink)(goDir, goCacheDir);
      const modCache = (0, import_path4.join)(goDir, "pkg", "mod");
      const buildCache = (0, import_path4.join)(goDir, "go-build");
      setEnvPaths(modCache, buildCache);
      goDir = goCacheDir;
    } else if (isUnix && goDir === goCacheDir) {
      const hash = (0, import_crypto.createHash)("md5").update(workPath).digest("hex").slice(0, 8);
      const tmpBase = (0, import_path4.join)((0, import_os.tmpdir)(), `vercel-go-cache-${hash}`);
      const tmpModCache = (0, import_path4.join)(tmpBase, "mod");
      const tmpBuildCache = (0, import_path4.join)(tmpBase, "go-build");
      await (0, import_fs_extra.mkdirp)((0, import_path4.join)(goDir, "pkg", "mod"));
      await (0, import_fs_extra.mkdirp)((0, import_path4.join)(goDir, "go-build"));
      await (0, import_fs_extra.mkdirp)(tmpBase);
      await (0, import_fs_extra.remove)(tmpModCache);
      await (0, import_fs_extra.symlink)((0, import_path4.join)(goCacheDir, "pkg", "mod"), tmpModCache);
      await (0, import_fs_extra.remove)(tmpBuildCache);
      await (0, import_fs_extra.symlink)((0, import_path4.join)(goCacheDir, "go-build"), tmpBuildCache);
      setEnvPaths(tmpModCache, tmpBuildCache);
    }
    env.GOROOT = goDir;
    env.PATH = `${(0, import_path4.join)(goDir, "bin")}${import_path4.delimiter}${PATH}`;
  };
  const goDirs = {
...
async function download({ dest, version: version2 }) {
  ...
  if (/\.zip$/.test(filename)) {
    const zipFile = (0, import_path4.join)((0, import_os.tmpdir)(), filename);
    try {
      ...
      while (entry) {
        ...
        if (fileName) {
          const destPath = (0, import_path4.join)(dest, fileName);
          if (/\/$/.test(fileName)) {
...
async function parseGoModVersionFromModule(modulePath) {
  let version2;
...
function parseGoModVersion(content) {
  ...
  const toolchainMatches = /^\s*toolchain\s+go((\d+)\.(\d+)(?:\.(\d+)|\w+\d+)?)\s*(?:\/\/.*)?$/gm.exec(
    content
  );
  const toolchain = toolchainMatches ? toolchainMatches[1] : void 0;
...
async function detectGoEntrypoint(workPath, configuredEntrypoint) {
  ...
  for (const candidate of GO_CANDIDATE_ENTRYPOINTS) {
    if (await (0, import_fs_extra2.pathExists)((0, import_path5.join)(workPath, candidate))) {
      (0, import_build_utils2.debug)(`Detected Go entrypoint: ${candidate}`);
      return candidate;
    }
  }
  return null;
...
async function initPrivateGit(credentials) {
  const gitCredentialsPath = (0, import_path7.join)((0, import_os2.homedir)(), ".git-credentials");
  ...
  await (0, import_fs_extra4.writeFile)(gitCredentialsPath, credentials);
}
...
Manually assigning 'GO111MODULE' is not recommended.
  ...
  `);
    ...
    const originalEntrypointAbsolute = (0, import_path7.join)(workPath, entrypoint);
    const renamedEntrypoint = getRenamedEntrypoint(entrypoint);
    if (renamedEntrypoint) {
      await (0, import_fs_extra4.move)((0, import_path7.join)(workPath, entrypoint), (0, import_path7.join)(workPath, renamedEntrypoint));
      undo.fileActions.push({
        to: (0, import_path7.join)(workPath, entrypoint),
        from: (0, import_path7.join)(workPath, renamedEntrypoint)
      });
      entrypoint = renamedEntrypoint;
    }
    const entrypointAbsolute = (0, import_path7.join)(workPath, entrypoint);
    const entrypointDirname = (0, import_path7.dirname)(entrypointAbsolute);
    const { goModPath, isGoModInRootDir } = await findGoModPath2(
      entrypointDirname,
      workPath
    );
    if (!goModPath && await (0, import_fs_extra4.pathExists)((0, import_path7.join)(workPath, "vendor"))) {
      throw new Error("`go.mod` is required to use a `vendor` directory.");
    }
    const analyzed = await getAnalyzedEntrypoint({
      entrypoint,
      modulePath: goModPath ? (0, import_path7.dirname)(goModPath) : void 0,
      workPath
    });
    ...
    const modulePath = goModPath ? (0, import_path7.dirname)(goModPath) : void 0;
    const go = await createGo({
      modulePath,
      opts: {
...
async function buildHandlerWithGoMod({
  ...
  let goModDirname;
  if (goModPath !== void 0) {
    goModDirname = (0, import_path7.dirname)(goModPath);
    const backupFile = (0, import_path7.join)(goModDirname, `__vc_go.mod.bak`);
    await (0, import_fs_extra4.copy)(goModPath, backupFile);
    undo.fileActions.push({
      to: goModPath,
      from: backupFile
    });
    const goSumPath = (0, import_path7.join)(goModDirname, "go.sum");
    const isGoSumExists = await (0, import_fs_extra4.pathExists)(goSumPath);
    if (!isGoSumExists) {
      undo.fileActions.push({
        to: void 0,
        // delete
  ...
  const vendorModulesPath = (0, import_path7.join)(
  ...
  const entrypointArr = entrypoint.split(import_path7.posix.sep);
  let goPackageName = `${packageName}/${packageName}`;
  const goFuncName = `${packageName}.${handlerFunctionName}`;
  const relPackagePath = goModDirname ? import_path7.posix.relative(goModDirname, entrypointDirname) : "";
  if (relPackagePath) {
    goPackageName = import_path7.posix.join(packageName, relPackagePath);
  }
  let mainGoFile;
  ...
  try {
    let finalDestination = (0, import_path7.join)(entrypointDirname, packageName, entrypoint);
    if (entrypointArr.length > 1) {
      finalDestination = (0, import_path7.join)(
        entrypointDirname,
        packageName,
    ...
    if (!goModPath || (0, import_path7.dirname)(entrypointAbsolute) === (0, import_path7.dirname)(goModPath)) {
      ...
      undo.directoryCreation.push((0, import_path7.dirname)(finalDestination));
    }
  } catch (err) {
  ...
  if (goModPath && isGoModInRootDir) {
    ...
    baseGoModPath = (0, import_path7.dirname)(goModPath);
  } else {
...
async function buildHandlerAsPackageMain({
  ...
  try {
    const src = [
      (0, import_path7.join)(entrypointDirname, MAIN_GO_FILENAME),
      entrypointAbsolute
    ].map((file) => (0, import_path7.normalize)(file));
...
async function renameHandlerFunction(fsPath, from, to2) {
  let fileContents = await (0, import_fs_extra4.readFile)(fsPath, "utf8");
  const fromRegex = new RegExp(String.raw` ${from}\b`, "g");
  fileContents = fileContents.replace(fromRegex, ` ${to2}`);
  await (0, import_fs_extra4.writeFile)(fsPath, fileContents);
}
...
async function cleanupFileSystem({
  ...
  for (const action of fileActions.reverse()) {
    if (action.to) {
      await (0, import_fs_extra4.move)(action.from, action.to, { overwrite: true });
    } else {
  ...
  const undoDirectoryPromises = directoryCreation.map(async (directory) => {
    ...
    if (!contents.length) {
      return (0, import_fs_extra4.rmdir)(directory);
    }
    return void 0;
  });
  await Promise.all(undoDirectoryPromises);
}
async function findGoModPath2(entrypointDir, workPath) {
  let goModPath = void 0;
  let isGoModInRootDir = false;
  let dir = entrypointDir;
  while (!isGoModInRootDir) {
...
function isPortInfo(v2) {
  return v2 && typeof v2.port === "number";
}
function isReadable(v2) {
  return v2 && v2.readable === true;
}
async function copyEntrypoint(entrypoint, dest) {
  const data = await (0, import_fs_extra4.readFile)(entrypoint, "utf8");
  const patched = data.replace(/\bpackage\W+\S+\b/, "package main");
  await (0, import_fs_extra4.writeFile)((0, import_path7.join)(dest, "entrypoint.go"), patched);
}
async function copyDevServer(functionName, dest) {
  const data = await (0, import_fs_extra4.readFile)((0, import_path7.join)(__dirname, "../dev-server.go"), "utf8");
  const patched = data.replace("__HANDLER_FUNC_NAME", functionName);
  await (0, import_fs_extra4.writeFile)((0, import_path7.join)(dest, "vercel-dev-server-main.go"), patched);
}
async function writeEntrypoint(dest, goPackageName, goFuncName) {
  const modMainGoContents = await (0, import_fs_extra4.readFile)(
    (0, import_path7.join)(__dirname, "../main.go"),
    "utf8"
  );
  ...
  await (0, import_fs_extra4.writeFile)(dest, mainModGoContents, "utf-8");
}
async function writeGoMod({
  ...
  if (goModPath) {
    const goModRelPath = (0, import_path7.relative)(destDir, (0, import_path7.dirname)(goModPath));
    const goModContents = await (0, import_fs_extra4.readFile)(goModPath, "utf-8");
    contents = goModContents.replace(/^module\s+.+$/m, contents).replace(
      /^(replace .+=>\s*)(.+)$/gm,
      (orig, replaceStmt, replacePath) => {
        if (replacePath.startsWith(".")) {
          let newPath = (0, import_path7.join)(goModRelPath, replacePath);
    ...
    if (moduleName) {
      let relPath = (0, import_path7.normalize)(goModRelPath);
      if (!relPath.endsWith("/")) {
        relPath += "/";
      }
...
async function findGoWorkFile(goWorkDir, workPath) {
  while (!await (0, import_fs_extra4.pathExists)((0, import_path7.join)(goWorkDir, "go.work"))) {
    if (goWorkDir === workPath) {
      return;
    }
    goWorkDir = (0, import_path7.dirname)(goWorkDir);
  }
  return (0, import_path7.join)(goWorkDir, "go.work");
}
async function writeGoWork(destDir, workPath, modulePath) {
  ...
  let goVersion;
  if (goWorkPath) {
    const contents2 = await (0, import_fs_extra4.readFile)(goWorkPath, "utf-8");
    const goVersionMatch = contents2.match(/^go\s+(\d+\.\d+(\.\d+)?)/m);
    if (goVersionMatch) {
    ...
    const addPath = (path) => {
      if (path) {
        if (path.startsWith(".")) {
          workspaces.add((0, import_path7.relative)(destDir, (0, import_path7.join)(workPath, path)));
        } else {
          workspaces.add(path);
        }
      }
    ...
    workspaces.add((0, import_path7.relative)(destDir, modulePath));
    const goModPath = (0, import_path7.join)(modulePath, "go.mod");
    if (await (0, import_fs_extra4.pathExists)(goModPath)) {
      const goModContents = await (0, import_fs_extra4.readFile)(goModPath, "utf-8");
...
`;
  ...
  contents += `use (
${Array.from(workspaces).map((w2) => `  ${w2}
`).join("")})
`;
  await (0, import_fs_extra4.writeFile)((0, import_path7.join)(destDir, "go.work"), contents, "utf-8");
}
async function startDevServer(opts) {
  const { entrypoint, workPath, config, meta = {} } = opts;
  const { devCacheDir = (0, import_path7.join)(workPath, ".vercel", "cache") } = meta;
  ...
  const entrypointDir = (0, import_path7.dirname)(entrypointWithExt);
  const tmp = (0, import_path7.join)(devCacheDir, "go", Math.random().toString(32).substring(2));
  const tmpPackage = (0, import_path7.join)(tmp, entrypointDir);
  await (0, import_fs_extra4.mkdirp)(tmpPackage);
  const { goModPath } = await findGoModPath2(
    (0, import_path7.join)(workPath, entrypointDir),
    workPath
  );
  const modulePath = goModPath ? (0, import_path7.dirname)(goModPath) : void 0;
  const analyzed = await getAnalyzedEntrypoint({
  ...
  const portFile = (0, import_path7.join)(
    TMP,
  ...
  child.on("close", async () => {
    try {
      await (0, import_async_retry.default)(() => (0, import_fs_extra4.remove)(tmp));
    } catch (err) {
